...
- [[summaries/s2-013-Introduction-to-AI-monitoring-New-Relic|Introduction to AI monitoring - New Relic Documentation]] — 作为官方产品文档， 本文的信息密度和可信度较高， 但深度上自然受限于入门指南的定位—— 它告诉你 "有什么" 和 "怎么用"， 但不会深入讨论 "为什么这样设计" 或 "与其他方案相比优劣如何"。
