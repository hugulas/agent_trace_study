...
- [[summaries/s2-016-Arize-aiphoenix-GitHub|Arize-ai/phoenix: AI Observability & Evaluation]] — Phoenix 给我最深刻的印象是它的「整合性」设计哲学。
- [[summaries/s2-011-Elastic-Brings-Observability-to-AI-Agent|Elastic Brings Observability to AI Agents with Amazon Bedrock AgentCore]] — 这则新闻稿虽然内容不可访问，但其标题本身包含了丰富的信息密度。
