...
- [[summaries/p-015-View-oriented-Conversation-Compiler-for|View-oriented Conversation Compiler for Agent Trace Analysis]] — 上下文学习研究长期关注高层架构选择：生成器、反射器与策展人的角色分解，层次化记忆的组织与检索，工具使用，以及从智能体轨迹中提取经验并泛化。
